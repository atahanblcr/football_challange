    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">Yeni Soru Oluştur</h1>
            <p className="text-sm text-slate-500 mt-0.5">Soru detaylarını ve cevap listesini belirleyin.</p>
          </div>
        </div>
        <div className="flex gap-3">
          <button
            ...
            className="flex items-center gap-2 bg-surface hover:bg-surface-variant text-slate-300 px-5 py-2.5 rounded-xl border border-surface-variant transition-all font-semibold"
          >
            <Save size={18} />
            Taslak Kaydet
          </button>
          ...
          >
            {createMutation.isPending ? <Loader2 size={18} className="animate-spin" /> : <Rocket size={18} />}
            Yayınla
          </button>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-surface p-6 rounded-2xl border border-surface-variant shadow-sm space-y-4">
            ...
            <div>
              ...
              <textarea
                className="w-full bg-background border border-surface-variant rounded-xl px-4 py-3 text-white focus:border-primary outline-none min-h-[100px] resize-none text-lg font-medium shadow-inner"
                placeholder="Örn: La Liga'da 2000 sonrası en fazla asist yapan 7 futbolcuyu bul"
                value={form.title}
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="La Liga, World Cup, vb."
                  value={form.category}
        ...
        <div className="space-y-6">
          <div className="bg-surface p-6 rounded-2xl border border-surface-variant shadow-sm space-y-5">
            ...
            <div className="pt-2">
              ...
              <div>
                ...
                />
                <p className="text-[10px] text-slate-600 mt-1.5 italic">Boş bırakılırsa "Yayınla" dendiği an aktif olur.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-primary/5 border border-primary/20 p-4 rounded-xl flex gap-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Soruyu <strong>Yayınla</strong> dediğinizde hemen veya ayarlanan tarihte kullanıcılara görünür hale gelecektir. 
              <strong>Taslak</strong> olarak kaydederseniz sadece listede görürsünüz.
            </p>
          </div>
        </div>
      </div>
